 ...
 * @author nbasu
 */
public class daftardosen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfemail.setFont(new java.awt.Font("Montserrat", 0, 16)); // NOI18N

        jLabel6.setFont(new java.awt.Font("Montserrat", 0, 16)); // NOI18N
        jLabel6.setText("Email");

        tfnip.setFont(new java.awt.Font("Montserrat", 0, 16)); // NOI18N

        jLabel7.setFont(new java.awt.Font("Montserrat", 0, 16)); // NOI18N
        jLabel7.setText("NIP");

        tfpass.setFont(new java.awt.Font("Montserrat", 0, 16)); // NOI18N
        ...
        up.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(up, javax.swing.GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE)
        );
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(up, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
        );

        jPanel3.setBackground(new java.awt.Color(242, 111, 33));
        jPanel3.setForeground(new java.awt.Color(242, 111, 33));

        kem.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(tfnip, javax.swing.GroupLayout.PREFERRED_SIZE, 527, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void upMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_upMouseClicked
        ...
        try {
            ...
            String sql = "UPDATE  dosen set password_dosen = '" + tfpass.getText()
                    + "' WHERE nip_dosen = '" + tfnip.getText()+"' and "
                    + "email = '"+tfemail.getText()+"'";
            java.sql.PreparedStatement pst = con.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(rootPane, "Update Berhasil");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Email dan NoNIP Salah"+e.getMessage());
        }
