...
public class AdminLOGIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfusername.setFont(new java.awt.Font("Montserrat", 1, 16)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(tfpassword, javax.swing.GroupLayout.PREFERRED_SIZE, 413, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(jPanel5, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(tfusername, javax.swing.GroupLayout.PREFERRED_SIZE, 413, javax.swing.GroupLayout.PREFERRED_SIZE))))))
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        if (c.length() == 0 && b.length() == 0) {
            ...
            try {
                String sql = "SELECT * FROM login_admin WHERE email = '" + tfusername.getText()
                        + "' AND password = '" + tfpassword.getText() + "'";
                java.sql.Connection con = (Connection) Koneksi.configDB();
                java.sql.Statement st = con.createStatement();
                java.sql.ResultSet rs = st.executeQuery(sql);
                if (rs.next()) {
                    if (tfusername.getText().equals(rs.getString("email"))
                            && tfpassword.getText().equals(rs.getString("password"))) {
                        String nama = rs.getString("nama");
                        String no = rs.getString("no_baa");
                        TabelAdmin a = new TabelAdmin(nama, no);
                        a.setVisible(true);
                        this.dispose();
                    }
                } else {
                ...
                JOptionPane.showMessageDialog(rootPane, "Login Gagal kesalhan sistem, Silahkan Hubungi Admin" + e.getMessage());
            }
        }
