...
//            pencarian bertahap level demi level, memeriksa seluruh node 
//            pada kedalaman tertentu sebelum masuk ke level yang lebih dalam lagi hingga 
//                    ditemukan tujuan atau goal state-nya. 

    private int node;
    /* total number number of nodes in the graph */
